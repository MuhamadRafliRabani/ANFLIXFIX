...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 z-[9999] flex max-h-11 w-full translate-x-0 items-center justify-between bg-transparent px-2 py-3 text-white shadow-sm transition-all duration-300 md:justify-normal md:gap-8 md:px-8 dark:bg-white ${
